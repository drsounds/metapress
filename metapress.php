...
function metapress_init($post_types, $settings, $taxonomies) {
    ...
    add_action( 'add_meta_boxes', 'metapress_add_meta_box' );
...
function metapress_register_my_menus() {
    ...
    foreach($GLOBALS['post_types'] as $k => $post_type) {
        register_post_type($k, array(
            'labels' => array(
              'name' => __($post_type['title'], 'metapress'),
              'singular_name' => __($post_type['title'], 'metapress'),
            ),
            'description' => __($post_type['description'], 'metapress'),
            'public' => true,
            'menu_position' => 5,
 ...
 */
function metapress_add_meta_box() {
